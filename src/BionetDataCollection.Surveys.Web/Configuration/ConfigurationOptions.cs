...
namespace BionetDataCollection.Surveys.Web.Configuration
{
    /// <summary>
    ///This class holds various configuration values used by the BionetDataCollection.Surveys.Web project.
    /// </summary>
