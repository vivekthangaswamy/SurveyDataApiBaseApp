...
namespace BionetDataCollection.Surveys.Security.Policy
{
    /// <summary>
    /// This class defines various operations that can be performed on a <see cref="BionetDataCollection.Surveys.Data.DataModels.Survey"/>
    /// </summary>
