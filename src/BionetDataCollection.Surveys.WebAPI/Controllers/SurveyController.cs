...
namespace BionetDataCollection.Surveys.WebAPI.Controllers
{
    /// <summary>
    ...
    public class SurveyController : Controller
    {
        ...
        public async Task<IActionResult> Get(int id)
        {
            ...
            // The AuthorizationService uses the policies in the BionetDataCollection.Surveys.Security project
